...
class FadeIn(Behavior):
    """FadeIn is a transition behavior. It takes a python equation in t,
    ...
    which the color coefficient is always 1. Color coefficents are applied to
    ...
    def behaviorInit (self):
        ...
        if 'tEquation' in self.argDict:
            state['tEquation'] = eval('lambda t:' + self['tEquation'])
        else:
            state['tEquation'] = eval('lambda t:' + 't/' + str(self['TimeOut']*30.0))
        state['t'] = 0
